...
abstract class PTreeNode extends Node {
  ...
  static GlobalKey get selectedPropertyGK {
    ...
    print("_selectedPropertyGK in use: ${_selectedPropertyGK.currentWidget.runtimeType}");
  ...
  Widget toPropertyNodeContents(BuildContext context) => NodePropertyButton_String(
        ...
        onChangeF: (s) {
          ...
          if (s.contains('/') && s.split('/').length == 2) {
            ...
            if (w != null && h != null) onDoubleChange.call(decimalValue = w / h);
          } else {
        ...
        child: Row(
          ...
          children: [
            NodePropertyButton_String(
              ...
              onChangeF: (s) {
                if (s.toLowerCase() == 'infinity') {
                  onSizeChange.call((widthValue = double.infinity, heightValue));
                  return;
                }
                if (s.contains('/') && s.split('/').length == 2) {
                  var split = s.split('/');
                  ...
                  if (part1 != null && part2 != null) onSizeChange.call((widthValue = part1 / part2, part2));
                } else {
            ...
            NodePropertyButton_String(
              ...
              onChangeF: (s) {
                if (s.toLowerCase() == 'infinity') {
                  onSizeChange.call((widthValue, heightValue = double.infinity));
                  return;
                }
                if (s.contains('/') && s.split('/').length == 2) {
                  var split = s.split('/');
                  double? part1 = double.tryParse(split[0]);
                  double? part2 = double.tryParse(split[1]);
                  if (part1 != null && part2 != null) onSizeChange.call((part2, heightValue = part1 / part2));
                } else {
