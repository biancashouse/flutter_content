...
///
class TextEditor3 extends StatefulWidget {
  ...
  @override
  TextEditor3State createState() => TextEditor3State();
}

class TextEditor3State extends State<TextEditor3> {
  ...
  void initState() {
    ...
    _focusNode = FocusNode(
      onKeyEvent: (node, event) {
        ...
        if ((widget.multiLine && enterPressedWithShift) || (!widget.multiLine && (enterPressedWithShift || enterPressedWithoutShift))) {
  ...
  Widget build(BuildContext context) {
    ...
    InputDecoration decoration = widget.isPassword
        ? InputDecoration(
    ...
    if (kIsWeb && keyboardType == TextInputType.number) {
